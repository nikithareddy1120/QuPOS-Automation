...
class PywinautoUtilities:
    ...
    def clear_text(self, app, control_identifier, friendlyNameOfElement, timeout):
        ...
        try:
            ...
            logging.error(f"Unable to clear the text from {friendlyNameOfElement}: {e}")
    ...
    def mouse_hover(self, app, control_identifier, friendlyNameOfElement, timeout):
        ...
        try:
            ...
            logging.error(f"Unable to perform mouse hover action on the element {friendlyNameOfElement}: {e}")
            raise
